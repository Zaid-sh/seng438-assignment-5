...
The lab was quite different and more frustrating compared to our previous labs. Instead of continuing our work using the same programs and packages like we did in the previous lab, we switched gears completed where we now have to use a tool we have never touched before and use data that we also haven't seen before. 
