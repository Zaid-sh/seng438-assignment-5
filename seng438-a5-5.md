...
For this lab, our group was split into 2 pairs, one using C-SFRAT to perform reliability growth testing on the hypothetical SUT and the other pair using RDC-11 to generate a reliability demonstration chart for the hypothetical SUT. Once both pairs found their results, we collaborated to compare our findings and the strengths and and weaknesses of our respective methods.

# Difficulties encountered, challenges overcome, and lessons learned

There were some frustrating challenges encountered in the form of incompatibilities between error reports that made comparing results very difficult. The only lessons learned was the hands-on experience with reliability testing outlined in the objective sections.

# Comments/feedback on the lab itself

The lab was quite different and more frustrating compared to our previous labs. Instead of continuing our work using the same programs and packages as we did in the previous lab, we switched gears and completed, where we now have to use a tool we have never touched before and use data we haven't seen. In our opinion, this lab was very vague and did not explain many concepts properly, and many datasets had too few headers included, and figuring out the other headers was mainly educated guesswork.
