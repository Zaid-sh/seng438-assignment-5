...
*Put a Summary of what we did with C-SFRAT*
...
In order to find the best two models for this specific dataset, we sorted the "Log-Likelihood" in ascending order (smallest to largest):
...
We also generated an Intensity Graph with the two best models:

<img src="media/Intensity_Graph.png"/>

## Range Analysis
*This is where the Laplace score will go with the table*
